  ...
  for (const operatorInput of SEED_OPERATOR_CONFIGS) {
    ...
    if (existingOperator) {
      ...
      await ctx.db.patch(operatorId, {
        ...
        physicalAddress: operatorInput.physicalAddress,
        city: operatorInput.city,
        locationLabel: operatorInput.locationLabel,
        latitude: operatorInput.latitude,
        longitude: operatorInput.longitude,
